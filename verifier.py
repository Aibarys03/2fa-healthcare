...
class FaceVerifier:
    ...
    def _load_embeddings(self):
        """Загружает сохранённые эмбеддинги пользователей."""
        if os.path.exists(self.embeddings_path):
            ...
            print(f"Загружены эмбеддинги для {len(self.user_embeddings)} пользователей")
    ...
    def delete_user(self, user_id: str) -> bool:
        """Удаляет пользователя из базы эмбеддингов."""
